...
const StaffHomePage = () => {
  ...
  const set_Flow = () => {
    setIsLoading(true);
    navigation("/Non-Acc-Staff-Home/SetWorkFlow");
  ...
  const Get_Status = (StatusType) => {
    ...
    sessionStorage.setItem("MainHome", "Non-Acc-Staff-Home");
    navigation("/Non-Acc-Staff-Home/Status");
  };
        ...
        <div className="Main-Background">
          ...
          <div className="welcome-with-Logout-button">
            ...
            <div className="buttons-sets-home">
              <button className="buttons-hover" onClick={set_Flow}>
                Create Document Flow Path
              </button>
              <button
